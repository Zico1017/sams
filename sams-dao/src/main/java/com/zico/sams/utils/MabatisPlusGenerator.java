...
public class MabatisPlusGenerator {
    ...
    //基本包名
    private static String basePackage = "com.zico.sams";
    //作者
    private static String authorName = "zico";
    //要生成的表名
    private static String[] tables = {"TBL_BRH_PROFIT_M_SHOW"};
    //table前缀
    private static String prefix = "TBL_";

    //数据库配置四要素
    private static String driverName = "oracle.jdbc.driver.OracleDriver";
    private static String url = "jdbc:oracle:thin:@172.30.0.242:1520:oradb01";
    private static String username = "dev_ktb_bonus";
    private static String password = "dev_ktb_bonus";
